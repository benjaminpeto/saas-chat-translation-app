				...
				<div className="relative isolate pt-14 dark:bg-gray-900">
					...
					>
						<div
							...
							style={{
								clipPath:
									"polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% v32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%,17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
							}}
						/>
					</div>
						...
						<div className="mx-auto max-w-7xl px-6 lg:px-8">
							<div className="mx-auto max-w-2xl text-center">
								<h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
									Chat with anyone, no matter the language barrier...
								</h1>
								<p className="mt-6  text-lg leading-8 text-gray-600 dark:text-gray-300">
									You speak your language, they speak theirs. No more copy-paste
									from Google Translate.{" "}
									<span className="font-bold text-indigo-600 dark:text-indigo-500">
										Let AI handle the translation for you.
									</span>
								</p>
							...
							<div className="mt-16 flow-root sm:mt-24">
								<div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
									<Image
										unoptimized
										src={DemoGif}
										alt="App screenshot video about how the app looks and feels"
										width={2432}
										height={1442}
